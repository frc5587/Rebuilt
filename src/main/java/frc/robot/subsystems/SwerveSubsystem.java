...
public class SwerveSubsystem extends TunerSwerveDrivetrain implements Subsystem {
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Distance to hub", Vector3.subtract(new Vector3(getState().Pose), ShooterConstants.getGoal(DriverStation.getAlliance().orElse(Alliance.Blue))).get2D().length());
