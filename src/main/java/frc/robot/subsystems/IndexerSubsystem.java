...
public class IndexerSubsystem extends SubsystemBase {
  private SmartMotorControllerConfig smcConfig = IndexerConstants.APPLY_SMC_CONFIG
  ...
  private FlyWheelConfig flywheelCfg = IndexerConstants.APPLY_INDEXER_CONFIG
      .apply(new FlyWheelConfig(sparkSmartMotorController));
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("indexer velocity", sparkSmartMotorController.getMechanismVelocity().in(RPM));
    if (sparkSmartMotorController.getMechanismSetpointVelocity().isPresent()) {
      SmartDashboard.putNumber("indexer setpoint", sparkSmartMotorController.getMechanismSetpointVelocity().get().in(RPM));
    }
  }
  ...
  public void simulationPeriodic() {
    indexer.simIterate();
  }//a curse upon thy family if thou removest this comment
}
